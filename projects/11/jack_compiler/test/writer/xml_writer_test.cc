...
namespace jack_compiler {
    TEST(XMLWriterTest, Single) {
        ...
        token_type.terminal_token_ = TerminalTokenType::kIdentifier;
    ...
    TEST(XMLWriterTest, LevelTwo) {
        ...
        Node::TokenUnion token_type;
        token_type.non_terminal_token_ = NonTerminalTokenType::kClass;
        auto item_root = std::make_shared<Node>(false, token_type);
        token_type.terminal_token_ = TerminalTokenType::kSymbol;
    ...
    TEST(XMLWriterTest, LevelThree) {
        ...
        token_type.non_terminal_token_ = NonTerminalTokenType::kStatements;
        auto item_child1 = std::make_shared<Node>(false, token_type);

        token_type.terminal_token_ = TerminalTokenType::kSymbol;
        auto item_child2 = std::make_shared<Node>(true, token_type, ";");

        token_type.terminal_token_ = TerminalTokenType::kKeyword;
