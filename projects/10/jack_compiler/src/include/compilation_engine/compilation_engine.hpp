...
namespace jack_compiler {
    ...
    private:
         ...
         */
        bool CompileKeyword(std::shared_ptr<Node> parent, std::vector<KEYWORD_TYPE> limit_types);
        /**
         * Only compile the limited symbols. Return false if we can't compile it
         */
        bool CompileSymbol(std::shared_ptr<Node> parent, std::vector<std::string> limit_symbols);
        /**
