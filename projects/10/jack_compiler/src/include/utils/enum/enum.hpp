...
namespace jack_compiler {
    ...
    const static std::unordered_map<NON_TERMINAL_TOKEN_TYPE, std::string> NON_TERMINAL_TOKEN_TABLE {
        ...
        {NON_TERMINAL_TOKEN_TYPE::WHILE_STATEMENTS, "whileStatements"},
        {NON_TERMINAL_TOKEN_TYPE::IF_STATEMENTS, "ifStatements"},
        {NON_TERMINAL_TOKEN_TYPE::RETURN_STATEMENTS, "returnStatements"},
        {NON_TERMINAL_TOKEN_TYPE::LET_STATEMENTS, "letStatements"},
        {NON_TERMINAL_TOKEN_TYPE::DO_STATEMENTS, "doStatements"},
